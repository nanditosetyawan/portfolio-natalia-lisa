...
const entries: PropertyRegistryEntry[] = [
  ...
  defineProperty({ propertyKey: 'position.x', category: 'position', categoryLabel: 'POSITION', categoryOrder: 40, label: 'X', control: 'number', type: 'number', order: 10, rowKey: 'position-xy', commandType: 'SET_PROPERTY', capability: 'position', propertyPath: 'x', databaseMapping: snapshot('layout.{entityId}.x'), defaultValue: 0, validation: validCssLength(), previewUpdater: translatePreview, styleKey: 'layout.x' }),
  defineProperty({ propertyKey: 'position.y', category: 'position', categoryLabel: 'POSITION', categoryOrder: 40, label: 'Y', control: 'number', type: 'number', order: 20, rowKey: 'position-xy', commandType: 'SET_PROPERTY', capability: 'position', propertyPath: 'y', databaseMapping: snapshot('layout.{entityId}.y'), defaultValue: 0, validation: validCssLength(), previewUpdater: translatePreview, styleKey: 'layout.y' }),
  defineProperty({ propertyKey: 'position.width', category: 'position', categoryLabel: 'POSITION', categoryOrder: 40, label: 'Width', control: 'text', type: 'string', order: 30, rowKey: 'position-size', commandType: 'SET_PROPERTY', capability: 'position', propertyPath: 'width', databaseMapping: snapshot('layout.{entityId}.width'), defaultValue: '', validation: validCssLength(true, true), previewUpdater: stylePreview('width', cssLength), styleKey: 'layout.width' }),
  defineProperty({ propertyKey: 'position.height', category: 'position', categoryLabel: 'POSITION', categoryOrder: 40, label: 'Height', control: 'text', type: 'string', order: 40, rowKey: 'position-size', commandType: 'SET_PROPERTY', capability: 'position', propertyPath: 'height', databaseMapping: snapshot('layout.{entityId}.height'), defaultValue: '', validation: validCssLength(true, true), previewUpdater: stylePreview('height', cssLength), styleKey: 'layout.height' }),
  defineProperty({ propertyKey: 'position.rotation', category: 'position', categoryLabel: 'POSITION', categoryOrder: 40, label: 'Rotation', control: 'number', type: 'number', order: 50, commandType: 'SET_PROPERTY', capability: 'position', propertyPath: 'rotation', databaseMapping: snapshot('layout.{entityId}.rotation'), defaultValue: 0, validation: validRotation, dependency: supports('rotate'), previewUpdater: stylePreview('rotate', cssRotation), styleKey: 'layout.rotation' }),

  defineProperty({ propertyKey: 'effects.opacity', category: 'effects', categoryLabel: 'EFFECTS', categoryOrder: 50, label: 'Opacity', control: 'number', type: 'number', order: 10, commandType: 'SET_PROPERTY', capability: 'effects', propertyPath: 'opacity', databaseMapping: snapshot('backgrounds.{entityId}.opacity'), defaultValue: 1, validation: validNumber(0, 1), previewUpdater: stylePreview('opacity'), styleKey: 'effects.opacity' }),
  defineProperty({ propertyKey: 'effects.shadow', category: 'effects', categoryLabel: 'EFFECTS', categoryOrder: 50, label: 'Shadow', control: 'text', type: 'string', order: 20, commandType: 'SET_PROPERTY', capability: 'effects', propertyPath: 'boxShadow', databaseMapping: snapshot('backgrounds.{entityId}.boxShadow'), defaultValue: '', placeholder: 'CSS box shadow', validation: validString(256), previewUpdater: stylePreview('box-shadow'), styleKey: 'effects.boxShadow' }),
  ...
  defineProperty({ propertyKey: 'advanced.objectId', category: 'advanced', categoryLabel: 'ADVANCED', categoryOrder: 60, label: 'Object ID', control: 'readonly', type: 'metadata', order: 10, commandType: 'SET_PROPERTY', capability: 'advanced', propertyPath: 'objectId', databaseMapping: metadata('objectId'), defaultValue: '', validation: validMetadata, readOnly: true, copyable: false }),
  defineProperty({ propertyKey: 'advanced.capabilities', category: 'advanced', categoryLabel: 'ADVANCED', categoryOrder: 60, label: 'Capabilities', control: 'readonly', type: 'metadata', order: 20, commandType: 'SET_PROPERTY', capability: 'advanced', propertyPath: 'capabilities', databaseMapping: metadata('capabilities'), defaultValue: '', validation: validMetadata, readOnly: true, copyable: false }),
  defineProperty({ propertyKey: 'advanced.validation', category: 'advanced', categoryLabel: 'ADVANCED', categoryOrder: 60, label: 'Validation status', control: 'readonly', type: 'metadata', order: 30, commandType: 'SET_PROPERTY', capability: 'advanced', propertyPath: 'validationStatus', databaseMapping: metadata('validationStatus'), defaultValue: 'Valid', validation: validMetadata, readOnly: true, copyable: false }),
  defineProperty({ propertyKey: 'advanced.section', category: 'advanced', categoryLabel: 'ADVANCED', categoryOrder: 60, label: 'Section', control: 'readonly', type: 'metadata', order: 40, commandType: 'SET_PROPERTY', capability: 'advanced', propertyPath: 'section', databaseMapping: metadata('section'), defaultValue: '', validation: validMetadata, readOnly: true, copyable: false }),
  defineProperty({ propertyKey: 'advanced.layer', category: 'advanced', categoryLabel: 'ADVANCED', categoryOrder: 60, label: 'Layer', control: 'readonly', type: 'metadata', order: 50, commandType: 'SET_PROPERTY', capability: 'advanced', propertyPath: 'layer', databaseMapping: metadata('layer'), defaultValue: '', validation: validMetadata, readOnly: true, copyable: false }),
...
const categoryMetadata: Record<string, { category: string; label: string; order: number; presentation: 'inline' | 'accordion'; capability: string }> = {
  ...
  typography: { category: 'font', label: 'FONT', order: 10, presentation: 'accordion', capability: 'typography' },
  ...
  behavior: { category: 'advanced', label: 'ADVANCED', order: 60, presentation: 'accordion', capability: 'advanced' }
}
...
export function validateRegisteredProperties(snapshotValue: EditorSnapshot, entities: EntityDescriptor[] = []): RegisteredPropertyError[] {
  ...
  for (const entry of entries) {
    ...
    for (const entityId of Object.keys(record as Record<string, unknown>)) {
      ...
      const value = readSnapshotPath(snapshotValue, propertyPath)
